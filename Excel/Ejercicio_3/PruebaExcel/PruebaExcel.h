...
protected:
	...
	void InitializeGui()
	{
		...
		tbxValor.CreateX(WS_EX_CLIENTEDGE, NULL, WS_CHILD | WS_TABSTOP | WS_VISIBLE | ES_AUTOHSCROLL | ES_LEFT | ES_WINNORMALCASE, 0.60854, 1.98438, 8.44021, 0.60854, hWnd, 1001);
		fontArial009A.CreateX(L"Arial", 0.317500, false, false, false, false);
		tbxValor.Font = fontArial009A;
	}
	//_________________________________________________
